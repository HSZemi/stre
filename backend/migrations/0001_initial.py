# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-12 15:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='account_history_account', to=settings.AUTH_USER_MODEL)),
                ('akteur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='account_history_akteur', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Aktion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('markierung', models.CharField(choices=[('badge-default', 'Grau'), ('badge-danger', 'Rot'), ('badge-warning', 'Gelb'), ('badge-success', 'Grün'), ('badge-info', 'Blau')], default='badge-default', max_length=30)),
                ('datei', models.CharField(max_length=1024)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aktion_antragsdaten_bearbeiten', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aktion_antragsdaten_bearbeiten', to='backend.Aktion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                ('beschreibung', models.TextField(blank=True)),
                ('datei', models.CharField(default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daten_sofort_loeschen', models.CharField(choices=[('nicht_sofort_loeschen', 'Nachweise werden für zwei Semester nach Antragstellung gespeichert und können in diesem Zeitraum für Folgeanträge genutzt werden. Das Nutzerkonto wird zwei Semester nach der letzten Antragstellung deaktiviert.'), ('sofort_loeschen', 'Nachweise werden gelöscht, sobald sie nicht mehr für die Bearbeitung oder Prüfung benötigt werden. Sie können danach nicht mehr für Folgeanträge genutzt werden. Das Nutzerkonto wird nach vollständiger Bearbeitung aller Anträge deaktiviert.')], default='sofort_loeschen', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_end', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='uebergang_to_set', to='backend.Status')),
                ('status_start', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='uebergang_from_set', to='backend.Status')),
            ],
        ),
        migrations.AddField(
            model_name='history',
